        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              ...
              { step: "3", title: "Téléchargez", desc: "ZIP autonome prêt à déployer", icon: Download }].map((item, index) => (
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {[
              ...
              { icon: Download, title: "Guide HTML", desc: "Instructions pas à pas" }].map((item, index) => (
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center gap-8 items-center">
            {[
              ...
              { icon: Package, text: "Code 100% à vous" }].map((badge, index) => (
